	...
	<div id="content">
		...
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/jordan.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/kobe.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/shoes.jpg" class="carousel"></div>
				</div>
		...
		<div id="video">
			<video controls autoplay width="445px" height="300px">
				<source src="video/Banned Air Jordan 1 Commercial.mp4" type="video/mp4">
			</video>
		</div>
