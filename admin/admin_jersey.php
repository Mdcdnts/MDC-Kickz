...
<body>
	...
	<br>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_jersey.php");
			}}
		}
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Jersey</h2></center></div>
			<br />
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `product` WHERE category='jersey' ORDER BY product_id DESC") or die(mysqli_error());
 ...
 $row = $result->fetch_array();
  ...
  echo "<script>window.location = 'admin_jersey.php'</script>";
