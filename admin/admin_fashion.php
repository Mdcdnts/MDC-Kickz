...
<body>
	...
	<br>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_fashion.php");
			}}
		}
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_fashion.php" style="font-size:15px; margin-left:15px;">LifeStyle</a></li>
					<li><a href="admin_jersey.php"style="font-size:15px; margin-left:15px;">Jersey</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>LifeStyle</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `product` WHERE category='fashion' ORDER BY product_id DESC") or die(mysqli_error());
  ...
  if(isset($_POST['stockin'])){
   ...
   $row = $result->fetch_array();
	...
	echo "<script>window.location = 'admin_fashion.php'</script>";
